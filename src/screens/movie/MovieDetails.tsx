...
import { CastActor } from '../../presentation/components/cast/CastActor';
import { FullMovie } from '../../core/entities/movie.entity';
import { Formatter } from '../../config/helpers/formatter';
import React, { useEffect,useState } from 'react';
import Tts from 'react-native-tts';
import LeerButton from '../../presentation/components/shared/LeerButton';
...
export const MovieDetails = ({movie, cast}: Props) => {
  ...
  return (
    <>
      ...
      <View>
      <LeerButton title={isSpeaking ? 'Detener lectura' : 'Comenzar lectura'} onPress={speakText} />
    </View>
